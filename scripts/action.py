...
class ContextSwitch(py_trees.behaviour.Behaviour):
    ...
    def __init__(self, name="ContextSwitch"):
        ...
        self.planner_selector = "old context"        
        self.subscriber = rospy.Subscriber('chatter', String, callback)        
    ...
    def initialise(self):
        ...
        self.planner_selector = "new context"

    def update(self):
        """
        Just returns RUNNING while it waits for other activities to finish.
        """
        self.logger.debug("%s.update()[RUNNING][%s]" % (self.__class__.__name__, self.planner_selector))
